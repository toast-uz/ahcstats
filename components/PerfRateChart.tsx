...
import { xRateList, myXRateList } from '../data/ahc-stats';
  ...
  <div className="container">
    <ScatterChart width={700} height={350}
      ...
      <text x={700 / 2} y={10} fill="black" textAnchor="middle" dominantBaseline="central">
          <tspan fontSize="1.2rem">Latest Heuristic Rate vs Perf (you are red if attended)</tspan>
      </text>
      <CartesianGrid />
      ...
      <Scatter name="all" data={xRateList} fill="#8884d8" />
      <Scatter name="you" data={myXRateList} fill="red" />
